/* =====================================================================
   OMBA401 · cohort announcement banner (student side, read-only).
   Fetches omba401/_announce from the teaching-70f1c Realtime DB and,
...
(function(){
  ...
  var NS="omba401";
  var DISMISS_KEY="omba401_ann_dismissed";
