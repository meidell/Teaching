/* =====================================================================
   UMEF407 · cohort announcement banner (student side, read-only).
   Fetches umef407/_announce from the teaching-70f1c Realtime DB and,
...
(function(){
  ...
  var NS="umef407";
  var DISMISS_KEY="umef407_ann_dismissed";
  ...
  function injectCSS(){
    ...
    c.textContent=
    '#ann-bar{display:flex;align-items:center;gap:12px;background:#176B87;color:#fff;'+
